...
const basePath = '/cnno-1775101616625';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'OG Rolls: Our original sweet rolls are a timeless classic, soft, fluffy, and filled with a hint of sweetness that will leave you craving more.', icon: 'domain' }, { n: 'Product 2', d: 'Pistachio Rolls: For a twist on our classic recipe, try our pistachio rolls, infused with the nutty flavor and vibrant green color of pistachios, adding a fun and playful touch to any gathering.', icon: 'architecture' }, { n: 'Product 3', d: 'Chocolate Rolls: Indulge in the richness of our chocolate rolls, smothered in a decadent chocolate coating that\'s sure to satisfy any sweet tooth.', icon: 'chair' }, { n: 'Product 4', d: 'Baby Rolls: Perfect for little hands or as a sweet treat on-the-go, our baby rolls are bite-sized bundles of joy, packed with the same love and care as our full-sized rolls.', icon: 'eco' }, { n: 'Product 5', d: 'Party Box: Whether you\'re celebrating a special occasion or just want to share the love, our party box is the perfect solution, featuring an assortment of our delicious rolls, carefully curated to delight your guests.', icon: 'precision_manufacturing' }];
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To craft exceptional sweet rolls that inspire connection, comfort, and happiness, while fostering a culture of kindness, inclusivity, and passion.</p></div>
